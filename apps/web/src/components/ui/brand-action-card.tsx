  ...
  return (
    <Link
      ...
      className={cn(
        ...
        isPrimary
          ? "bg-gradient-to-r from-rose-50 via-white to-white border-rose-200 shadow-sm hover:border-rose-300"
          : "ht-card-hover",
    ...
    >
      ...
      <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-slate-100 text-slate-500 group-hover:text-white group-hover:bg-rose-600 transition-all shrink-0 mr-3">
