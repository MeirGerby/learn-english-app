...
description: Multi-agent orchestration philosophy and process framework for this project (orchestrator/supervisor roles, task lifecycle, verification levels, autonomy levels, git/agent workflow). Load this before large-scale architecture planning, setting up new specialized agents, or coordinating multi-step/multi-agent work - not needed for routine small edits.
---
